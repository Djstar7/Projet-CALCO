    ...
    // FONCTION SUR FONCTION
        ...
        function resultat(e1,e2){
            ...
            do{  
                ...
                //sOT DIRECTEMENT DE BOUCLE LORSQUE LES FONCTIONS MATHEMATIQUES SONT A LA POSITON -1
                if(posMath == -1){
                    break;
                }
...
//:: A PROPOS DE LA DIV D'ID pave
    ...
    // STYLE DE LA PAGE
        calco.style.width='175px';
        calco.style.borderWidth='5px';
        calco.style.borderStyle = 'solid';
        calco.style.borderColor= 'rgb(89, 0, 255)';
        calco.style.borderRadius = '5px';
        calco.style.backgroundColor = 'darkblue';

        // STYLE DE L'ENTETE
            Entete.style.width = '100%';
            Entete.style.height = '8%';
        // STYLE DE L'ECRAN
            newEcran.style.borderWidth = '1px';
            newEcran.style.borderColor = 'red';
            newEcran.style.borderStyle = 'solid';
            newEcran.style.backgroundColor = 'WHITE';
            // STYLE DE L'ECRAN D'ENTREE
                ecran_entree.style.borderBottom = '0px';
                ecran_entree.style.width = '100%';
                ecran_entree.style.fontSize = '100%';
                ecran_entree.style.height = '4%';

            // STYLE DE L'ECRAN DE SORTIE
                ecran_sortie.style.borderTop = '0px';
                ecran_sortie.style.textAlign = 'right';
                ecran_sortie.style.height = '4%';
                ecran_sortie.style.fontWeight = 'blod';
                ecran_sortie.style.fontSize = '100%';
        // STYLE DE FONCTION
            fonction.style.display = 'grid'; 
            fonction.style.gridTemplateColumns = '1fr 1fr 1fr 1.2fr';
            fonction.style.height = '6%';
        
        // STYLE SUR FONCTIONTRIGONOMETRIQUE
            fonctionTrigo.style.display = 'grid'; 
            fonctionTrigo.style.gridTemplateColumns = '1fr 1fr 1fr 1fr';
            

        // STYLE DE MATHS
            math.style.display = 'grid';
            math.style.gridTemplateColumns = '1fr 1fr 1fr 1fr';
        



        // STYLE DU BLOCK PAVE
            pave.style.width = '100%';
            pave.style.fontColor = 'black';
        

            // STYLE DE CHIFFRE
                chiffre.style.display = 'grid';
                chiffre.style.gridTemplateColumns = '25%';
                chiffre.style.gridTemplateColumns = '1fr 1fr 1fr';
                chiffre.style.float = 'left';
                chiffre.style.width = '75%';
                chiffre.style.backgroundColor = 'black';

            // STYLE DE SIGNE
                signe.style.display = 'grid';
                signe.style.gridTemplateColumns = '100%';
                signe.style.marginLeft = '75%';
